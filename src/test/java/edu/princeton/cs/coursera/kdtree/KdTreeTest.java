...
public class KdTreeTest
{
    ...
    private KdTree empty;
    private KdTree c10;
    private KdTree c1000;
    private KdTree c10000;
    private KdTree in10k;
    private KdTree in20k;
    private KdTree in100k;
    ...
    {
        empty = new KdTree();
        c10 = createKdTreeFromFile(c10fileName);
    }

    private KdTree createKdTreeFromFile(String fileName)
    {
    ...
    {
        c1000 = createKdTreeFromFile(c1000fileName);
        c10000 = createKdTreeFromFile(c10000fileName);
        in10k = createKdTreeFromFile(in10kfileName);
    ...
    public void testContains()
    {
        c1000 = createKdTreeFromFile(c1000fileName);
        c10000 = createKdTreeFromFile(c10000fileName);
        in20k = createKdTreeFromFile(in20kfileName);
    ...
    {
        in100k = createKdTreeFromFile(in100kfileName);
    ...
    public void testNearest()
    {
        ...
        assertTrue("Incorrect nearest point, should be " + correct.toString()
                + ", result is " + nearestPoint.toString(),
